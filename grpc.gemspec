...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/security/credentials/downscoped/downscoped_credentials.cc )
  s.files += %w( src/core/lib/security/credentials/downscoped/downscoped_credentials.h )
