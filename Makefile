...
LIBGRPC_SRC = \
    ...
    src/core/lib/security/credentials/downscoped/downscoped_credentials.cc \
...
src/core/lib/security/credentials/downscoped/downscoped_credentials.cc: $(OPENSSL_DEP)
