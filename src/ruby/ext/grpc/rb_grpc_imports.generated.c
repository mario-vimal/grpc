...
grpc_downscoped_credentials_create_type grpc_downscoped_credentials_create_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_downscoped_credentials_create_import = (grpc_downscoped_credentials_create_type) GetProcAddress(library, "grpc_downscoped_credentials_create");
