...
typedef grpc_call_credentials*(*grpc_downscoped_credentials_create_type)(grpc_call_credentials* creds, const char* cab_json_string);
extern grpc_downscoped_credentials_create_type grpc_downscoped_credentials_create_import;
#define grpc_downscoped_credentials_create grpc_downscoped_credentials_create_import
